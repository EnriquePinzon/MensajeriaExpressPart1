...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Numero cedula cliente: "+ cliente1.getCedula());
        System.out.println("=================");
        System.out.println("Numero cedula empleado: "+ empleado1.getCedula());
        ...
        System.out.println(envio1.getIdGuia());
//        System.out.println("================================");
